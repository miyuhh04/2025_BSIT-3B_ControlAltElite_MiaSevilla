...
<div class="form-group">
  <div class="col-md-8">
    <label class="col-md-4 control-label" for="ROLE">Register as:</label>
    <div class="col-md-8">
      <select class="form-control input-sm" id="ROLE" name="ROLE" required>
        ...
        <option value="Employer">Employer</option>
			...
			<div class="form-group">
				...
				<label class="col-md-4 control-label" for=
					...
					<div class="col-md-8">
					<input name="JOBID" type="hidden" value="<?php echo isset($_GET['job']) ? htmlspecialchars($_GET['job'], ENT_QUOTES, 'UTF-8') : ''; ?>">
