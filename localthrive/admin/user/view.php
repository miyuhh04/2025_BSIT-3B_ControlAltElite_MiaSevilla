                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          <option value="Administrator"  <?php echo ($singleuser->ROLE=='Administrator') ? 'selected="true"': '' ; ?>>Employer</option>
                          <option value="Staff" <?php echo ($singleuser->ROLE=='Staff') ? 'selected="true"': '' ; ?>>Administrator</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
